...
################################################################
    ...
    def test_bond_route(self):
        response = self.app.get('/bond?seed=99')
        self.assertIn('seed=99', response.data)
        self.assertTemplateUsed('oneliner.html')
        self.assertNotIn('oneliner-list', response.data)
        self.assert200(response)

    def test_multi_bond_toolow_route(self):
        response = self.app.get('/bond?count=0')
        self.assertTemplateUsed('oneliner.html')
        self.assertNotIn('oneliner-list', response.data)
        self.assert200(response)

    def test_multi_bond_toohigh_route(self):
        response = self.app.get('/bond?count=101')
        self.assertTemplateUsed('oneliner.html')
        self.assertNotIn('oneliner-list', response.data)
        self.assert200(response)

    def test_multi_bond_nondigit_route(self):
        response = self.app.get('/bond?count=duck')
        self.assertTemplateUsed('oneliner.html')
        self.assertNotIn('oneliner-list', response.data)
        self.assert200(response)

    def test_multi_bond_route(self):
        response = self.app.get('/bond?count=5')
        self.assertTemplateUsed('oneliner.html')
