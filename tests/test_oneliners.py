...
#################################################################
    ...
    def test_artwork_route(self):
        ...
        self.assertIn('A Work of Art...', response.data)
...
#################################################################
    ...
    def test_resource_route(self):
        ...
        self.assertTemplateUsed('oneliner.html')
        self.assertIn('At Your Disposal...', response.data)
        self.assertNotIn('oneliner-list', response.data)
        self.assert200(response)
    ...
    def test_multi_resource_count(self):
        ...
        self.assertEqual(10,   len(re.findall('resource_oneliner', response.data)))
        self.assert200(response)
    ...
    def test_resource_builder_route(self):
        ...
        self.assertTemplateUsed('generic_builder.html')
        self.assertIn("Create a Resource", response.data)
        self.assert200(response)
...
################################################################
    ...
    def test_rumor_route(self):
        ...
        self.assertTemplateUsed('oneliner.html')
        self.assertIn('Did You Hear?', response.data)
        self.assertNotIn('oneliner-list', response.data)
        self.assert200(response)
    ...
    def test_multi_rumor_count(self):
        ...
        self.assertEqual(10,   len(     re.findall('rumor_oneliner', response.data)))
        self.assert200(response)

    def test_multi_rumor_toohigh_route(self):
        ''' '''
        response = self.app.get('/rumor?count=crackers')
        self.assertEqual(0,   len(     re.findall('rumor_oneliner', response.data)))
        self.assert200(response)

    def test_rumor_builder_route(self):
        response = self.app.get('/rumor_builder')
        self.assertTemplateUsed('generic_builder.html')
        self.assertIn('Create a Rumor', response.data)
        self.assert200(response)
...
################################################################
    ...
    def test_misfire_route(self):
        ...
        self.assertTemplateUsed('oneliner.html')
        self.assertIn('My Spell Misfired!', response.data)
        self.assertNotIn('oneliner-list', response.data)
        self.assert200(response)
    ...
    def test_multi_misfire_count(self):
        ...
        self.assertEqual(10,   len(     re.findall('misfire_oneliner', response.data)))
        self.assert200(response)

    def test_multi_misfire_count_bad(self):
        ''' '''
        response = self.app.get('/misfire?count=duck')
        self.assertEqual(0,   len(     re.findall('misfire_oneliner', response.data)))
        self.assert200(response)

    def test_misfire_builder_route(self):
        response = self.app.get('/misfire_builder')
        self.assertTemplateUsed('generic_builder.html')
        self.assertIn('Create a Misfire', response.data)
        self.assert200(response)
...
################################################################
    ...
    def test_flaw_route(self):
        ...
        self.assertTemplateUsed('oneliner.html')
        self.assertIn('My Greatest Flaw...', response.data)
        self.assertNotIn('oneliner-list', response.data)
        self.assert200(response)
    ...
    def test_multi_flaw_count(self):
        ...
        self.assertEqual(10,   len(     re.findall('flaw_oneliner', response.data)))
        self.assert200(response)

    def test_multi_flaw_count_bad(self):
        response = self.app.get('/flaw?count=duck')
        self.assertEqual(0,   len(     re.findall('flaw_oneliner', response.data)))
        self.assert200(response)
    ...
    def test_flaw_builder_route(self):
        ...
        self.assertTemplateUsed('generic_builder.html')
        self.assertIn('Create a Flaw', response.data)
        self.assert200(response)
...
################################################################
    ...
    def test_currency_route(self):
        ...
        self.assertTemplateUsed('oneliner.html')
        self.assertIn('Spare Some Change?', response.data)
        self.assertNotIn('oneliner-list', response.data)
        self.assert200(response)
    ...
    def test_multi_currency_count(self):
        ...
        self.assertEqual(10,   len(     re.findall('currency_oneliner', response.data)))
        self.assert200(response)

    def test_multi_currency_nondigit_route(self):
        ''' '''
        response = self.app.get('/currency?count=duck')
        self.assertEqual(0,   len(     re.findall('currency_oneliner', response.data)))
        self.assert200(response)

    def test_currency_builder_route(self):
        response = self.app.get('/currency_builder')
        self.assertTemplateUsed('generic_builder.html')
        self.assertIn('Create a Currency', response.data)
        self.assert200(response)
...
################################################################
    ...
    def test_jobposting_route(self):
        ...
        self.assertIn('Help Wanted!', response.data)
        self.assertTemplateUsed('oneliner.html')
        self.assert200(response)
    ...
    def test_multi_jobposting_count(self):
        ...
        self.assertEqual(10,   len(     re.findall('jobposting_oneliner', response.data)))
        self.assert200(response)

    def test_multi_jobposting_nondigit_route(self):
        ''' '''
        response = self.app.get('/jobposting?count=duck')
        self.assertEqual(0,   len(     re.findall('jobposting_oneliner', response.data)))
        self.assert200(response)
    ...
    def test_jobposting_builder_route(self):
        ...
        self.assertTemplateUsed('generic_builder.html')
        self.assertIn('Create a Jobposting', response.data)
        self.assert200(response)
...
################################################################
    ...
    def test_curse_route(self):
        ...
        self.assertIn('Unforseen Consequences...', response.data)
        self.assertTemplateUsed('oneliner.html')
        self.assert200(response)
    ...
    def test_multi_curse_count(self):
        ...
        self.assertEqual(10,   len(     re.findall('curse_oneliner', response.data)))
        self.assert200(response)

    def test_multi_curse_nondigit_route(self):
        ''' '''
        response = self.app.get('/curse?count=duck')
        self.assertEqual(0,   len(     re.findall('curse_oneliner', response.data)))
        self.assert200(response)
    ...
    def test_curse_builder_route(self):
        ...
        self.assertTemplateUsed('generic_builder.html')
        self.assertIn('Create a Curse', response.data)
        self.assert200(response)
