...
class TestGenerator(unittest.TestCase):
    ...
    def test_error_handling_roll(self):
        ...
        with self.assertRaises(ValueError) as cm:
            generator.select_by_roll('missing_size')
        self.assertEqual(str(cm.exception), "The key missing_size does not exist.")

        with self.assertRaises(LookupError) as cm:
            generator.select_by_roll('incompleteset_size')
        self.assertEqual(str(cm.exception),
                         'The key (incompleteset_size) appears to be empty for a roll of 10- This should never happen.')
    ...
    def test_render_template(self):
        ...
        self.assertEqual('A large string, a bigger string.',
                         generator.render_template("A large string, {{params.test_value}}."))
