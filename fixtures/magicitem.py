...
# Armor
    ...
    self.redis.lpush('armor_template', '{{ params.effect_description["name"] }} {{ params.category_description["name"]}}{%if params.ability_description%} of {{params.ability_description["name"]}}{%endif%}')
    self.redis.lpush('armor_visualcause', 'orc')
    self.redis.lpush('armor_visualeffect', 'sparkles')


# potion
    self.redis.lpush('potion_template', '{{ params.strength["name"] }} {{ params.effect_description["name"] }} {{ params.kind }}')
...
#weapon
    ...
    self.redis.lpush('weapon_template', '{{ params.effect_description["name"] }} {{ params.category_description["name"]}}{%if params.ability_description%} of {{params.ability_description["name"]}}{%endif%}')
